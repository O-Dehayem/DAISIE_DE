...
Likelihood_ES_unknown_lineage <- function(datalist, i, pars1) {
  ...
  interval1 <- function(t, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      dDM <- -(pars1[5] + pars1[1] + pars1[2] ) * DM + (pars1[5] * D1 + 2 * pars1[1] * D1 * E1 ) * D0 +
        (pars1[2] + pars1[5] * E1 + pars1[1] * E1^2)* DD0
